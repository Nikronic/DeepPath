...
_**In this fork, I fixed some issues and changed implementation based on the reference 3 (salesforce), but still default code runs the original implementation. (For running my implementation, explicit flagging needed which has not been implemented intentionally)**_
...
All "enhancements" codes borrowed from [Salesforce's MultiHopKG code](https://github.com/salesforce/MultiHopKG)<br>
